...
import { connectorConfigured, gatewayFetch, GatewayError } from "./shared/gateway";
...
const FROM = process.env['NOTIFICATION_FROM_EMAIL'] || "Gradr <onboarding@resend.dev>";
const APP_URL = process.env['APP_PUBLIC_URL'] || "https://gradr.me";
...
export const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const isSystem = Boolean(cronSecret && cronSecret === process.env['CRON_SECRET']);
