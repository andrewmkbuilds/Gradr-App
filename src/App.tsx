...
const AdminVoiceHealth = lazy(() => import("@/pages/AdminVoiceHealth"));
    ...
    <DashboardLayout>
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
         ...
         <Route path="/admin/voice-health" element={<RequireAdmin><AnimatedPage><AdminVoiceHealth /></AnimatedPage></RequireAdmin>} />
