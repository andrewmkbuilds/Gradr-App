            ...
            <div key={item.question}>
              <dt>
                <button
                  ...
                  className="flex w-full items-center justify-between gap-4 px-4 py-4 text-left transition-colors hover:bg-secondary/60 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
                >
