...
import { search as firecrawlSearch, FirecrawlError } from "./firecrawl.ts";
...
const perplexityProvider: ResearchProvider = {
  id: "perplexity",
  available: () => !!Deno.env.get("PERPLEXITY_API_KEY"),
...
const firecrawlProvider: ResearchProvider = {
  id: "firecrawl",
  available: () => !!Deno.env.get("FIRECRAWL_API_KEY") && !!Deno.env.get("LOVABLE_API_KEY"),
