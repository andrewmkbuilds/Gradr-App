-- Update published legal documents to reference gradr.me domain
BEGIN;

UPDATE legal_documents
SET content = $TERMS$## 1. Agreement to these terms

Gradr is operated by Gradr (trading as Gradr), reachable at support@gradr.me. These Terms & Conditions form a binding agreement between you and us covering your access to and use of the Gradr website at https://gradr.me, application and related services (the "Service").

By creating an account, signing in, or purchasing a plan on gradr.me you confirm that you have read, understood and agree to these terms. If you do not agree, you must stop using the Service.
...
- Tell us at support@gradr.me immediately if you suspect unauthorised access.
...
The Service itself — software, design, branding, scoring logic, prompts, and documentation — belongs to Gradr and its licensors. We grant you a personal, non-exclusive, non-transferable, revocable right to use the Service under these terms. No rights are granted beyond that, and the Gradr name and logo may not be used without written permission.
...
We offer a 30-day refund window as described in our Refund Policy. Statutory withdrawal rights, where they apply to you, are unaffected.
...
To the maximum extent permitted by law, Gradr is not liable for indirect, incidental, special, consequential or punitive damages, or for lost profits, lost opportunities, lost employment, or lost or corrupted data. Our total aggregate liability arising out of or relating to the Service is limited to the greater of the amounts you paid us in the twelve months before the event giving rise to the claim, or USD 100. Nothing in these terms excludes liability for fraud, death or personal injury caused by negligence, or any liability that cannot be limited by law.

## 21. Indemnification

You agree to indemnify and hold harmless Gradr and its officers, employees and contractors from claims, damages, liabilities and reasonable legal costs arising from your use of the Service, Your Content, your breach of these terms, or your violation of any law or third-party right.
...
Before starting formal proceedings, please contact us at support@gradr.me so we can try to resolve the issue informally. Payment and refund disputes are handled in the first instance by Paddle as Merchant of Record.
...
Questions about these terms: support@gradr.me. Payment, invoice and tax questions are handled by Paddle.com as Merchant of Record.$TERMS$,
    updated_at = now()
WHERE doc_type = 'terms' AND status = 'published';

UPDATE legal_documents
SET content = $PRIVACY$## 1. Introduction

This privacy notice explains how Gradr (trading as Gradr, "we", "us") collects, uses, shares and protects personal data when you use the Gradr website at https://gradr.me and application (the "Services").

We are the data controller for that personal data. If you have any question or want to exercise a privacy right, contact us at support@gradr.me.
...
No online service can be completely secure, so we cannot guarantee absolute security. Protect your own account with a strong, unique password and tell us at support@gradr.me if you suspect a problem.

## 11. Children and minors

Gradr is not intended for children under 16, and we do not knowingly collect their personal data. If you believe a child has given us personal data, contact support@gradr.me and we will delete it.
...
- **By email:** write to support@gradr.me with the request and the email address on your account.
...
Gradr — support@gradr.me. For payment-related privacy questions, Paddle.com acts as Merchant of Record and independent controller for transaction data.$PRIVACY$,
    updated_at = now()
